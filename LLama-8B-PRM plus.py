...
# input: instruction, responses, next response, answer, error reason
...
import pandas as pd
# load dataset
dataset = pd.read_parquet("PRM800K_with_error_reasons.parquet")
...
def formatting_prompts_func(examples):
    ...
    for i in range(len(examples["instruction"])):
        ...
        input_str += f"Error Reason: {examples['error_reason'][i]}\n"
